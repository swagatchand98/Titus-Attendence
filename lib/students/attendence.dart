    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        List<Attendance> updatedData = data
            .where((item) =>
                item['student_id'].toString() == widget.studentId.toString() &&
                    ...
                    child: Column(
                      children: [
                        TableCalendar(
                          ...
                          calendarFormat:
                              CalendarFormat.month, // Force Month View
                          availableCalendarFormats: const {
                            CalendarFormat.month: 'Month', // Remove week toggle
                          },
                          headerStyle: HeaderStyle(
                            formatButtonVisible:
                                false, // Hide "2 weeks" dropdown
                          ),
                          onPageChanged: (focusedDay) {
                            setState(() {
                              selectedMonth =
                                  focusedDay; // Update selected month
                            });
                            fetchHolidaysAndAttendance(
                                selectedMonth); // Automatically fetch data
                          },
                          daysOfWeekVisible:
                              false, // Optional: Hide weekday labels
                            ...
                            defaultBuilder: (context, day, focusedDay) {
                              return Container(
                                ...
                                decoration: BoxDecoration(
                                  color: _getDayColor(
                                      day), // Automatically update colors
                        ...
                        Container(
                          ...
                          child: Column(
                            mainAxisSize: MainAxisSize
                                .min, // Makes the container fit the content
                            children: [
                              Row(
                                mainAxisAlignment:
                              ...
                              Row(
                                ...
                                children: [
                                  Expanded(
                                      child: _buildStatCard('Working Days',
                                          workingDaysCount, Colors.blueAccent)),
                                  const SizedBox(width: 8),
                                  Expanded(
                                      child: _buildStatCard(
                                          'Holidays',
                                          holidayCount,
                                          const Color(0xFF4FF9B6))),
                                ],
