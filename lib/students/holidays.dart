...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: StudentHolidayScreen(),
    );
  }
}

class StudentHolidayScreen extends StatefulWidget {
  @override
  _StudentHolidayScreenState createState() => _StudentHolidayScreenState();
}

class _StudentHolidayScreenState extends State<StudentHolidayScreen> {
      ...
      try {
        ...
        setState(() {
          holidays = data
              ...
              .where((holiday) => userRole == "STUDENT" && (holiday.holidayFor == "STUDENT" || holiday.holidayFor == "BOTH"))
              .toList();
...
Future<void> _insertHolidayIntoAttendance(Holiday holiday) async {
  final insertUrl = 'https://titusattendence.com/proxy.php?table=students_attendance';
  ...
  Map<String, String> requestBody = {
    'student_id': 'ALL',  // Apply to all students
